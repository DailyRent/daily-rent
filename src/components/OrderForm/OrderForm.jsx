...
const OrderForm = ({ isOpen, closeModal }) => {
  ...
  return (
    <Formik
      ...
      validate={(values) => {
        try {
          validateYupSchema(values, schema, true, listOfAppartmentNumbers);
        } catch (err) {
    ...
    >
      {(formik) => {
        const { errors, touched, isValid, values, isSubmitting } = formik;
          ...
          <div className={styles.container}>
            ...
            {isSubmitting ? (
              ...
              <Form className={styles.form}>
                ...
                <div className={styles.innerWrap}>
                  <div className={styles.wrapError}>
                    <svg className={`${styles.icon} ${styles.iconPicker}`}>
                      <use href="/sprite.svg#icon-calendar" />
                    </svg>
                    <svg className={`${styles.icon} ${styles.iconPickerRight}`}>
                      ...
                      {({ form, field }) => {
                        ...
                        return (
                          <DatePicker
                            ...
                            onChange={(val) => setFieldValue("checkIn", val)}
                      ...
                      {({ form, field }) => {
                        ...
                        return (
                          <DatePicker
                            ...
                            selected={value}
                            onFocus={(e) => e.target.blur()}
                            onChange={(val) => setFieldValue("checkOut", val)}
                            includeDateIntervals={[
                              {
                                start: subDays(new Date(), 2),
                                end: addDays(new Date(), 20),
