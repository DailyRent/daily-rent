...
const UpdatingForm = ({ id, apart, mutate }) => {
    ...
    const [airCond, setAirCond] = useState(
        newAmenities.includes("Кондиціонер")
    );
    const [bath, setBath] = useState(newAmenities.includes("Ванна"));
    const [shower, setShower] = useState(
        newAmenities.includes("Душова кабіна")
    );
            ...
            <form className={styles.new} onSubmit={handleSubmit}>
                ...
                <label>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            setNewGoogleMapLocation(e.target.value)
                        }
                    />
                </label>
                <label>
